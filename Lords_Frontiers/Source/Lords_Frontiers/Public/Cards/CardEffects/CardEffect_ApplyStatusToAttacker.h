...
#include "CardEffect_ApplyStatusToAttacker.generated.h"

class UStatusEffectDef;

UCLASS( BlueprintType, meta = ( DisplayName = "Effect: Apply Status To Attacker" ) )
class LORDS_FRONTIERS_API UCardEffect_ApplyStatusToAttacker : public UCardEffect
{
	GENERATED_BODY()
