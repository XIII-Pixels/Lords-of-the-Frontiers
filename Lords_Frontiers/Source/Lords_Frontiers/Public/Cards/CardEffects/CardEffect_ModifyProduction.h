...
#include "CardEffect_ModifyProduction.generated.h"

UCLASS( BlueprintType, meta = ( DisplayName = "Effect: Modify Production" ) )
class LORDS_FRONTIERS_API UCardEffect_ModifyProduction : public UCardEffect
{
	GENERATED_BODY()
