...
AProjectile::AProjectile()
{
    ...
    // CollisionComponent_->OnComponentEndOverlap.AddDynamic(this, &AProjectile::OnCollisionEnd);
}
...
void AProjectile::OnCollisionStart(UPrimitiveComponent* overlappedComp,
    AActor* otherActor,
...
// void AProjectile::OnCollisionEnd(UPrimitiveComponent* overlappedComp,
//     AActor* otherActor,
//     UPrimitiveComponent* otherComp,
//     int32 otherBodyIndex)
// {
